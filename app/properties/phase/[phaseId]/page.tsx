      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="relative h-[50vh] md:h-[60vh] w-full">
          ...
          <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center text-white">
            <Link 
              href="/properties" 
              className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md hover:bg-white/30 transition-all duration-300 px-5 py-2.5 rounded-full w-fit mb-6 border border-white/40 font-semibold text-white hover:scale-105"
            >
            ...
            <div className="max-w-3xl mx-auto text-center">
              <div className="bg-blue-50 rounded-3xl p-8 md:p-12 shadow-xl">
                ...
                <p className="text-gray-600 text-lg mb-6">
                  {phase.name} is currently under development. We're creating something special for you!
                </p>
                <div className="bg-white rounded-xl p-6 mb-8 text-left">
                  <h3 className="font-semibold text-blue-600 mb-3">What to expect:</h3>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-gray-600"><Shield size={16} className="text-red-500" /> 24/7 Gated Security</li>
                    <li className="flex items-center gap-2 text-gray-600"><Sun size={16} className="text-red-500" /> Solar Street Lighting</li>
                    <li className="flex items-center gap-2 text-gray-600"><Droplets size={16} className="text-red-500" /> Community Boreholes</li>
                    <li className="flex items-center gap-2 text-gray-600"><Road size={16} className="text-red-500" /> Tarred Roads</li>
                    <li className="flex items-center gap-2 text-gray-600"><TreePine size={16} className="text-red-500" /> Recreational Parks</li>
                  </ul>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link 
                    href="/contact" 
                    className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-red-600 transition text-center"
                  >
                    Register Interest
                  </Link>
                  <Link 
                    href="/properties" 
                    className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-full font-semibold hover:bg-blue-600 hover:text-white transition text-center"
                  >
                    Browse Other Phases
                  </Link>
                </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex gap-4 text-gray-600 text-sm mb-4 pb-3 border-b border-gray-100">
                      <span className="flex items-center gap-1">
                        <Bed size={16} className="text-red-500" /> {house.beds} beds
                      </span>
                      <span className="flex items-center gap-1">
                        <Ruler size={16} className="text-red-500" /> {house.baths} baths
                      </span>
                      <span className="flex items-center gap-1">
                        <Home size={16} className="text-red-500" /> {house.size} m²
                      </span>
                    </div>
      ...
      <section className="py-12 md:py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-5 rounded-xl text-center shadow-md hover:shadow-lg transition">
              <div className="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <Road className="text-red-500" size={28} />
              </div>
      ...
      <section className="py-12 md:py-16 bg-red-600 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-base md:text-lg mb-6 max-w-2xl mx-auto">
            Contact our sales team to schedule a site tour or inquire about available houses in {phase.name}.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/contact" 
            ...
            <Link 
              href="/properties" 
              className="border-2 border-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-red-600 transition"
            >
              Browse Other Phases
            </Link>
          </div>
