...
import {
  Home, User, Edit, ClipboardList, CreditCard,
  Mail, LogOut, Menu, ChevronRight, Sparkles
} from 'lucide-react';

const menuItems = [
  { id: 'dashboard',   label: 'Dashboard',      icon: Home,          href: '/school/portal/jobs/dashboard' },
  { id: 'profile',     label: 'Staff Profile',  icon: User,          href: '/school/portal/jobs/profile' },
  { id: 'edit',        label: 'Edit Profile',   icon: Edit,          href: '/school/portal/jobs/edit-profile' },
  { id: 'recruitment', label: 'Job Recruitment',icon: ClipboardList, href: '/school/portal/jobs/recruitment' },
  { id: 'payments',    label: 'Online Payments',icon: CreditCard,    href: '/school/portal/jobs/payments' },
  { id: 'feedback',    label: 'Feedback',       icon: Mail,          href: '/school/portal/jobs/feedback' },
];
...
export default function JobsLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (parsed.portalType !== 'jobs') { router.push('/school/portal'); return; }
    setUser(parsed);
  }, [router]);
  ...
  return (
    <div className={`root ${collapsed ? 'collapsed' : ''}`}>
      ...
      <header className="mob-header">
        ...
        <span className="mob-brand">MIRA · Careers</span>
        ...
        <div className="brand">
          ...
          {!collapsed && (
            <div className="brand-text">
              ...
              <span className="brand-sub">Careers Portal</span>
            </div>
          )}
        ...
        <div className="user-card">
          ...
          {!collapsed && (
            <div className="u-info">
              ...
              <p className="u-role">Job Applicant</p>
            </div>
          )}
        </div>
      ...
      <main className="main">
        <div className="topbar">
          <div className="bc">
            <span className="bc-root">Careers Portal</span>
