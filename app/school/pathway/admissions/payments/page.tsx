...
import { CreditCard, CheckCircle, Clock, AlertCircle, Download, Lock } from 'lucide-react';
...
export default function AdmissionsPayments() {
  ...
  const fees = [
    { id: 'app',    label: 'Application Fee',       amount: 'USD 20',  status: 'due',  due: 'Jun 30 2025' },
    { id: 'assess', label: 'Assessment Fee',        amount: 'USD 15',  status: 'due',  due: 'Jul 15 2025' },
    { id: 'enrol',  label: 'Enrolment Deposit',     amount: 'USD 150', status: 'pending', due: 'On Acceptance' },
  ];
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p>View and settle your admissions fees securely.</p>
        </div>
      ...
      {paid && (
        <div className="success-banner">
          ...
          <div>
            ...
            <p className="sb-sub">Your payment is being processed. A receipt will appear in your history shortly.</p>
          </div>
        </div>
      )}
                ...
                >
                  ...
                  <div className="fee-right">
                    ...
                    <span className={`fee-badge ${f.status}`}>
                      {f.status === 'due' ? 'Due' : 'Pending Acceptance'}
                    </span>
                  </div>
                </div>
              ))}
        ...
        <div className="card pay-card">
          ...
          {!selected ? (
            <div className="select-hint">
              ...
              <p>Select a fee from the list to proceed with payment.</p>
            </div>
          ) : (
            <>
              ...
              {method === 'ecocash' && (
                <div className="method-form">
                  ...
                  <p className="method-note">You will receive a USSD prompt on this number to confirm payment.</p>
                </div>
              )}
              {method === 'card' && (
                <div className="method-form">
              ...
              {method === 'bank' && (
                <div className="method-form bank-details">
                  ...
                  <div className="bd-row"><span>Reference</span><strong>{user?.appId || 'MGPS-2025-001'}</strong></div>
                  <p className="bd-note">Use your Application ID as the payment reference. Email proof of payment to admissions@mgps.ac.zw</p>
                </div>
              )}
          ...
          <div className="secure-note">
            <Lock size={12} />
            <span>All transactions are encrypted and secured. MGPS does not store card details.</span>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .pay-card{display:flex;flex-direction:column;gap:0;height:fit-content}
        .select-hint{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;padding:32px 16px;text-align:center;color:#64748b;font-size:.82rem}
        ...
        .bd-row{display:flex;justify-content:space-between;align-items:center;padding:7px 0;border-bottom:1px solid #e8ecf4;font-size:.75rem;color:#64748b}
