...
import { User, Phone, Mail, MapPin, Briefcase, GraduationCap, FileText, Edit } from 'lucide-react';
...
export default function StaffProfile() {
  ...
  const profileFields = [
    ...
    { label: 'Position Applied',   value: user?.position   || 'Not set',    icon: Briefcase },
    { label: 'Highest Qualification', value: user?.qualification || 'Not set', icon: GraduationCap },
    { label: 'Application ID',     value: user?.appId      || 'MGPS-J-2025-001', icon: FileText },
  ];

  const documents = [
    { name: 'Curriculum Vitae (CV)',     status: 'submitted', label: 'Submitted' },
    { name: 'Academic Certificates',     status: 'submitted', label: 'Submitted' },
    { name: 'National ID / Passport',    status: 'submitted', label: 'Submitted' },
    { name: 'Professional References',   status: 'missing',   label: 'Missing' },
    { name: 'Teaching Certificate (PGDE/B.Ed)', status: 'pending', label: 'Under Review' },
    { name: 'Police Clearance',          status: 'missing',   label: 'Missing' },
  ];
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1>Staff Profile</h1>
          <p>Your professional information and application details.</p>
        </div>
        <Link href="/school/portal/jobs/edit-profile" className="edit-btn">
      ...
      <div className="profile-top">
        <div className="avatar-wrap">
          ...
          <div className="avatar-info">
            ...
            <p className="av-role">Job Applicant · {user?.position || 'Teaching Staff'}</p>
      ...
      <div className="two-col">
        ...
        <div className="card">
          ...
          <p className="doc-sub">3 of 6 documents received</p>
          ...
          <div className="doc-note">
            <FileText size={14} />
            <p>Missing documents must be submitted before your file can be shortlisted. Use Edit Profile to upload.</p>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .progress-fill{height:100%;background:linear-gradient(90deg,#0b2d6b,#2ecc71);border-radius:3px}
