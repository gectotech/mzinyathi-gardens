    ...
    return (
      <div className="success-wrap">
        <div className="success-card">
          ...
          <p>Your response has been shared with the MGPS HR team. We use all feedback to improve the recruitment experience for every applicant.</p>
  ...
  return (
    <div>
      <div className="page-header">
        <h1>Feedback</h1>
        <p>Help us improve the MGPS recruitment experience by sharing your thoughts.</p>
      </div>
      ...
      <div className="layout">
        <div className="card main-card">
          ...
          <div className="section">
            <p className="sec-label">How would you rate the recruitment experience so far?</p>
            <div className="stars">
              {[1, 2, 3, 4, 5].map(n => (
                <button
                  key={n}
          ...
          <div className="section">
            ...
            <textarea
              ...
              placeholder="Tell us about your recruitment experience — what worked well, what could be improved, or anything else you'd like the HR team to know…"
              rows={6}
            />
        ...
        <div className="side-col">
          <div className="card info-card">
            ...
            <p>MGPS is building its team from the ground up ahead of its 2027 launch. Feedback from applicants directly shapes our HR processes and communication.</p>
            <div className="info-items">
              <div className="info-item"><span className="dot blue" />Reviewed by HR leadership each month</div>
              <div className="info-item"><span className="dot green" />Completely confidential</div>
              <div className="info-item"><span className="dot gold" />Actively used to improve the portal</div>
            </div>
          </div>

          <div className="card contact-card">
            <h3>Contact HR Directly</h3>
            <p>For urgent recruitment queries, reach our HR office directly.</p>
            <div className="contact-item">
              <span className="contact-label">Email</span>
              <a href="mailto:hr@mgps.ac.zw">hr@mgps.ac.zw</a>
            </div>
            <div className="contact-item">
      ...
      <style jsx>{`
        ...
        .star{background:none;border:none;cursor:pointer;padding:0;display:flex;color:#e2e8f0;transition:transform .15s}
