...
import { Save, User, Phone, Mail, MapPin, Calendar, BookOpen, Upload, CheckCircle } from 'lucide-react';
...
export default function EditProfile() {
  ...
  const [form, setForm] = useState({
    ...
    dob: '', address: '', grade: '', guardian: '', guardianPhone: '',
  });
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1>Edit Profile</h1>
          <p>Keep your information up to date to ensure a smooth admissions process.</p>
        </div>
        {saved && (
      ...
      <div className="form-grid">
        <div className="card">
          ...
          <div className="field-group">
            <label><BookOpen size={13} /> Grade Applying For</label>
        ...
        <div className="side-col">
          <div className="card">
            <h2 className="card-title">Guardian / Parent Details</h2>
            <div className="field-group">
              <label>Guardian Full Name</label>
              <input name="guardian" value={form.guardian} onChange={handleChange} placeholder="Full name" />
            </div>
            <div className="field-group">
              <label>Guardian Phone</label>
              <input name="guardianPhone" value={form.guardianPhone} onChange={handleChange} placeholder="+263 7XX XXX XXX" />
            </div>
          </div>

          <div className="card">
            <h2 className="card-title"><Upload size={16} /> Upload Documents</h2>
            <p className="upload-hint">Upload any outstanding documents to complete your application.</p>
            {['Birth Certificate', 'Proof of Residence'].map(doc => (
      ...
      <style jsx>{`
        ...
        .card{background:white;border-radius:14px;padding:22px;border:1px solid #e8ecf4;margin-bottom:16px}
        ...
        .upload-btn{display:flex;align-items:center;gap:6px;padding:6px 14px;background:#0b2d6b;color:white;border-radius:6px;font-size:.75rem;font-weight:600;cursor:pointer;white-space:nowrap;transition:opacity .2s}
